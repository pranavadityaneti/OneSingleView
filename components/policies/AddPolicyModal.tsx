...
type PolicyType = 'Motor' | 'Health' | 'Commercial' | null;

export default function AddPolicyModal({ isOpen, onClose, userId, onSuccess }: AddPolicyModalProps) {
    ...
    const renderForm = () => {
        switch (selectedType) {
            ...
            case 'Health':
                return <GMCPolicyForm userId={userId} onClose={onClose} onSuccess={handleSuccess} />;
            case 'Commercial':
                    ...
                    <div className="p-8">
                        ...
                        <div className="grid gap-4">
                            ...
                            <button
                                ...
                                className="flex items-center p-4 border border-gray-200 rounded-xl hover:border-green-500 hover:bg-green-50 transition-all group text-left"
                            >
                                <div className="p-3 bg-green-100 text-green-600 rounded-lg group-hover:bg-green-200 transition-colors">
                                    <Heart className="w-6 h-6" />
                                </div>
                                <div className="ml-4">
                                    <h3 className="font-semibold text-gray-900 group-hover:text-green-700">Health Insurance</h3>
