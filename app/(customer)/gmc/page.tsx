...
export default function GMCPoliciesPage() {
    ...
    const totalLives = policies.reduce((sum, p) => sum + (p.no_of_lives || 0), 0);
        ...
        <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div className="stat-card bg-purple-50 border-purple-100">
                    <p className="stat-label">Total Lives Covered</p>
                    <p className="stat-value text-purple-600">{totalLives}</p>
                </div>
            </div>
                        ...
                        <table className="table">
                            <thead className="table-header">
                                <tr>
                                    ...
                                    <th className="table-header-cell">Lives</th>
                            ...
                            <tbody>
                                {policies.map((policy) => (
                                    <tr key={policy.id} className="table-row">
                                        <td className="table-cell font-medium">{policy.company_name}</td>
                                        ...
                                        <td className="table-cell">{policy.no_of_lives}</td>
